...
function NavBarDescriptions( {enneagram} ) {
    ...
    return (
        <nav id="descriptionNav">
            <NavLink className="enlarge" to={ isRepeat ? `/about` : `${enneagram}/about` }> About </NavLink>
            <NavLink className="enlarge" to={ `${enneagram}/strengths` }  action="REPLACE"> Strengths </NavLink>
